...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center  justify-center gap-4">
      ...
      <motion.p  initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.7,delay:0.6}} className="max-w-2xl mx-auto font-Ovo">
      Passionate about building responsive web applications using React.js & Tailwind CSS, and solving DSA problems in Java.
      </motion.p>
